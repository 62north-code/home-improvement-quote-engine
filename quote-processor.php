...
$windowConfigurations = isset($data['windowConfigurations']) ? $data['windowConfigurations'] : [];
// Access the door configurations
$doorConfigurations = isset($data['doorConfigurations']) ? $data['doorConfigurations'] : [];
